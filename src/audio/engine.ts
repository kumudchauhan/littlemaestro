...
export const RHYMES: Record<string, { name: string; notes: RhymeNote[] }> = {
  twinkle: {
    ...
    notes: [
      { note: "C4", duration: 600 }, { note: "C4", duration: 600 },
      { note: "G4", duration: 600 }, { note: "G4", duration: 600 },
      { note: "A4", duration: 600 }, { note: "A4", duration: 600 },
      { note: "G4", duration: 1200 },
      { note: "F4", duration: 600 }, { note: "F4", duration: 600 },
      { note: "E4", duration: 600 }, { note: "E4", duration: 600 },
      { note: "D4", duration: 600 }, { note: "D4", duration: 600 },
  ...
  jingle: {
    name: "Jingle Bells",
    notes: [
      { note: "E4", duration: 450 }, { note: "E4", duration: 450 },
      { note: "E4", duration: 900 },
      { note: "E4", duration: 450 }, { note: "E4", duration: 450 },
      { note: "E4", duration: 900 },
      { note: "E4", duration: 450 }, { note: "G4", duration: 450 },
      { note: "C4", duration: 675 }, { note: "D4", duration: 225 },
      { note: "E4", duration: 900 },
      { note: "F4", duration: 450 }, { note: "F4", duration: 450 },
      { note: "F4", duration: 450 }, { note: "F4", duration: 450 },
      { note: "F4", duration: 450 }, { note: "E4", duration: 450 },
      { note: "E4", duration: 450 }, { note: "E4", duration: 225 },
      { note: "E4", duration: 225 },
      { note: "E4", duration: 450 }, { note: "D4", duration: 450 },
      { note: "D4", duration: 450 }, { note: "E4", duration: 450 },
      { note: "D4", duration: 900 }, { note: "G4", duration: 900 },
      { note: "E4", duration: 450 }, { note: "E4", duration: 450 },
      { note: "E4", duration: 900 },
      { note: "E4", duration: 450 }, { note: "E4", duration: 450 },
      { note: "E4", duration: 900 },
      ...
      { note: "E4", duration: 450 }, { note: "E4", duration: 225 },
      { note: "E4", duration: 225 },
      { note: "G4", duration: 450 }, { note: "G4", duration: 450 },
      { note: "F4", duration: 450 }, { note: "D4", duration: 450 },
      { note: "C4", duration: 1350 },
    ],
  },
  happybirthday: {
    name: "Happy Birthday",
    notes: [
      { note: "C4", duration: 450 }, { note: "C4", duration: 300 },
      { note: "D4", duration: 750 }, { note: "C4", duration: 750 },
      { note: "F4", duration: 750 }, { note: "E4", duration: 1200 },
      { note: "C4", duration: 450 }, { note: "C4", duration: 300 },
      { note: "D4", duration: 750 }, { note: "C4", duration: 750 },
      { note: "G4", duration: 750 }, { note: "F4", duration: 1200 },
      { note: "C4", duration: 450 }, { note: "C4", duration: 300 },
      { note: "C5", duration: 750 }, { note: "A4", duration: 750 },
      { note: "F4", duration: 750 }, { note: "E4", duration: 750 },
      { note: "D4", duration: 1200 },
      { note: "Bb4", duration: 450 }, { note: "Bb4", duration: 300 },
      { note: "A4", duration: 750 }, { note: "F4", duration: 750 },
      { note: "G4", duration: 750 }, { note: "F4", duration: 1200 },
    ],
  },
  oldmcdonald: {
    ...
    notes: [
      { note: "C4", duration: 600 }, { note: "C4", duration: 600 },
      { note: "C4", duration: 600 }, { note: "G3", duration: 600 },
      { note: "A3", duration: 600 }, { note: "A3", duration: 600 },
      { note: "G3", duration: 1200 },
      { note: "E4", duration: 600 }, { note: "E4", duration: 600 },
      { note: "D4", duration: 600 }, { note: "D4", duration: 600 },
      { note: "C4", duration: 1200 },
    ],
  ...
  mary: {
    ...
    notes: [
      { note: "E4", duration: 600 }, { note: "D4", duration: 600 },
      { note: "C4", duration: 600 }, { note: "D4", duration: 600 },
      { note: "E4", duration: 600 }, { note: "E4", duration: 600 },
      { note: "E4", duration: 1200 },
      { note: "D4", duration: 600 }, { note: "D4", duration: 600 },
      { note: "D4", duration: 1200 },
      { note: "E4", duration: 600 }, { note: "G4", duration: 600 },
      { note: "G4", duration: 1200 },
      { note: "E4", duration: 600 }, { note: "D4", duration: 600 },
      { note: "C4", duration: 600 }, { note: "D4", duration: 600 },
      { note: "E4", duration: 600 }, { note: "E4", duration: 600 },
